<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item  <?= $title == 'Win Dev - Dashboard' ? 'active' : '';?>">
            ...
            <li class="nav-item <?= $title == 'Send Message' ? 'active' : '';?>">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-envelope"></i>
                    <span>Message</span>
                </a>
                <div id="collapseUtilities" class="collapse <?= $title == 'Send Message' ? 'show' : '';?>" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item <?= $title == 'Send Message' ? 'active' : '';?>" href="<?= base_url('mailbox/send');?>">Send</a>
                        <a class="collapse-item" href="utilities-border.html">Inbox</a>
                    </div>
                </div>
            </li>
